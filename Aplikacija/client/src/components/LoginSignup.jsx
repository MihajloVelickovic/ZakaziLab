...
const LoginSignup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(errorList).length === 0) {
            console.log("success! pressed submit and input fields are adequate");
            if (action === "Login"){
                let sendData = { email: formValues.email, password: formValues.password };
                var response = await loginUser(e, sendData);
                errorList['serverResponse'] = `${response}`;
            } else if (action === "Sign Up"){
        ...
        return (
            <div className='inputs'>
                ...
                {action !== "Sign Up" ? <></> : <>
                    ...
                    <div className='input' style={{marginBottom: formErrors.lastName ? "0px" : "10px"}}>
                        <img src={userImg} alt='' ></img>
                        <input type='text' name='lastName' placeholder='Last Name' value = {formValues.lastName} onChange={handleChange} onKeyDown={handleKeypress}></input>                        
                    </div>
                    ...
                    {typeOfUser === "admin" ? <></>: <>
                        ...
                        {typeOfUser === "student" ? <>
                            ...
                            <div className='input' style={{marginBottom: formErrors.birthDate ? "0px" : "10px"}}>
                                <img src={userImg} alt='' ></img>
                                <input className="textbox-n" type="text" onFocus={(e) => (e.target.type = "date")}
                                        onBlur={(e) => (e.target.type = "text")} name='birthDate' placeholder='Birth Date' value = {formValues.birthDate} onChange={handleChange} onKeyDown={handleKeypress}></input>                        
                            </div>
                        ...
                        <>
                            <div className='input' style={{marginBottom: formErrors.gradDate ? "0px" : "10px"}}>
                                <img src={userImg} alt='' ></img>
                                <input className="textbox-n" type="text" onFocus={(e) => (e.target.type = "date")}
                                        onBlur={(e) => (e.target.type = "text")} name='gradDate' placeholder='Graduation Date' value = {formValues.gradDate} onChange={handleChange} onKeyDown={handleKeypress}></input>                        
                            </div>
                            <p className="p-error">{formErrors.gradDate}</p>

                            <div className='input' style={{marginBottom: formErrors.gradFaculty ? "0px" : "10px"}}>
                                <img src={userImg} alt='' ></img>
                                <input type="text" name='gradFaculty' placeholder='Graduation Faculty' value = {formValues.gradFaculty} onChange={handleChange} onKeyDown={handleKeypress}></input>                        
                            </div>
                            ...
                            <>
                                <div className='input' style={{marginBottom: formErrors.phdGradDate ? "0px" : "10px"}}>
                                    <img src={userImg} alt='' ></img>
                                    <input className="textbox-n" type="text" onFocus={(e) => (e.target.type = "date")}
                                        onBlur={(e) => (e.target.type = "text")} placeholder="PhD Graduation Date" name='phdGradDate' value = {formValues.phdGradDate} onChange={handleChange} onKeyDown={handleKeypress}></input>                        
                                </div>
                                <p className="p-error">{formErrors.phdGradDate}</p>
                                <div className='input' style={{marginBottom: formErrors.phdGradFaculty ? "0px" : "10px"}}>
                                    <img src={userImg} alt='' ></img>
                                    <input type="text" name='phdGradFaculty' placeholder='PhD Graduation Faculty' value = {formValues.phdGradFaculty} onChange={handleChange} onKeyDown={handleKeypress}></input>                        
                                </div>
    ...
    return (
        <div className='login-signup-form'>
            <div className="container p-3 p-sm-5 mt-5 mb-5 col-md-8 col-lg-5 col-sm-8 col-10">
                    <div className="col-lg-10 offset-lg-1">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="d-flex justify-content-between mt-3">
                                ...
                                <Button type="button" className="btn btn-secondary btn-md" onClick={() => { setAction(action === "Login" ? "Sign Up" : "Login"); setFormErrors({}); }}>
                            ...
                            {action === "Sign Up" && (
                                <div className="mt-3">
                                    ...
                                    <DropdownButton id="userType" title={typeOfUser} onSelect={(eventKey) => { setTypeOfUser(eventKey); setFormErrors({}); }}>
